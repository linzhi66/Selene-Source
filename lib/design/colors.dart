...
class AppColors {
  ...
  /// 深色玻璃边框
  static Color get darkGlassBorder =>
      const Color(0xFF2A3532).withValues(alpha: 0.3);

  /// 浅色玻璃边框
  static Color get lightGlassBorder =>
  ...
  /// 根据主题获取表面色
  static Color surface({required bool isDark}) =>
      isDark ? darkSurface : lightSurface;

  /// 根据主题获取卡片色
  static Color card({required bool isDark}) => isDark ? darkCard : lightCard;
  ...
  /// 根据主题获取玻璃背景色
  static Color glassBackground({required bool isDark}) =>
      isDark ? darkGlass : lightGlass;

  /// 根据主题获取玻璃边框色
  static Color glassBorder({required bool isDark}) =>
